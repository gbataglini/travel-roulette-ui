        ...
        <div className="cursor-pointer flex font-sans text-gray-800 w-5/6">
          ...
          <ul className="md:flex md:items-center">
            <li className="md:ml-6 text-l">
              <Link to={`/home`} className="hover:text-white duration-300">
                HOME
              </Link>
            </li>
            <li className="md:ml-6 text-l">
              <Link to={`/upcoming`} className="hover:text-white duration-300">
                UPCOMING
              </Link>
            </li>
            <li className="md:ml-6 text-l">
              <Link to={`/history`} className="hover:text-white duration-300">
                HISTORY
              </Link>
            </li>
          </ul>
